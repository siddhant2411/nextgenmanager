...
public class VoucherNumberGenerator {
    ...
    public VoucherNumberGenerator(NumberSequenceRepository sequenceRepo,
    ...
    public String next(VoucherType type) {
        String fy  = currentFinancialYear();
        String key = type.prefix() + "-" + fy;
        ...
        return String.format("%s/%s/%05d", type.prefix(), fy, val);
    }
